...
import { ArrowLeft, ShieldCheck, CheckCircle2, XCircle, Clock } from "lucide-react";
...
export default async function CertificatePage({
  ...
  const verdict =
    (page.certificate?.status as keyof typeof VERDICT) ?? "IN_PROGRESS";
  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <p className="mt-3 text-center text-[12px] text-text-muted print:hidden">
        Use “Download / Print” → Save as PDF to share this certificate with the
        client.
      </p>
    </div>
  );
