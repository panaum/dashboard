"""Pagecheck — the check engine (deployed copy).

SOURCE OF TRUTH: services/pagecheck/engine.py. This copy is what Railway
deploys and what the Deliverables dashboard's Attribution tab calls; keep the
two identical. It supersedes attribution.py, which checked a subset.
